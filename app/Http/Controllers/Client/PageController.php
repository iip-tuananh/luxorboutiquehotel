...
class PageController extends Controller
{
    ...
    {
        $data['list'] = Project::where(['cate_service_slug'=>$slug,'status'=>1])->paginate(12);
    ...
    {
        $data['detail'] = Project::where('slug',$slug)->where('cate_service_slug',$cate)->first();
        $data['list'] = Project::where('status',1)->orderBy('id',"DESC")->limit(6)->get();
