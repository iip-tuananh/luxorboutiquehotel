    ...
    <main class="wrapper">
        ...
        <div class="wptb-page-heading">
            <div class="wptb-item--inner" style="background-image: url('{{ url('frontend/img/page-header-blog.jpg') }}');">
                ...
                <h2 class="wptb-item--title ">{{ $cateService->name }}</h2>
            </div>
        </div>
        <!-- Our Services -->
        <section>
                                    ...
                                    <div class="wptb-blog-grid1 highlight wow fadeInLeft">
                                        <div class="wptb-item--inner">
                                            <div class="wptb-item--image">
                                                <a href="{{ route('serviceDetail', ['cate' => $cateService->slug, 'slug' => $item->slug]) }}"
                                                    class="wptb-item-link"><img src="{{ $img[0] }}"
                                                        alt="img"></a>
                                            </div>
                                            <div class="wptb-item--holder">
                                                ...
                                                <h4 class="wptb-item--title"><a
                                                        href="{{ route('serviceDetail', ['cate' => $cateService->slug, 'slug' => $item->slug]) }}">{{ $item->name }}</a>
                                                </h4>
