...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('phong/{slug}.html','PageController@roomDetail')->name('roomDetail');
    ...
    Route::get('dich-vu.html','PageController@duanTieuBieu')->name('duanTieuBieu');
    Route::get('dich-vu/{cate}/{slug}.html','PageController@serviceDetail')->name('serviceDetail');
